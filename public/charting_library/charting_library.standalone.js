var TradingView = (function (e) {
    ...
    let Ve = !1;
    function Fe() {
        return "CL v29.6.0 (internal id 7388a2a6e02df803a33011b40077c533f89a55f0 @ 2025-08-13T13:50:29.067Z)";
    }
    const Ee = class {
        constructor(e) {
            if (
            ...
            "dark" === (this._options.theme ?? "light").toLowerCase() &&
                ...
                (Ve ||
                    ((Ve = !0),
                        console.log(
                            "Using CL v29.6.0 (internal id 7388a2a6e02df803a33011b40077c533f89a55f0 @ 2025-08-13T13:50:29.067Z)"
                        ))),
        ...
        _render(e, t, i) {
            ...
            const r = (function (e, t) {
                const i = new URL(`${e || ""}`, location.href).href,
                    o = JSON.parse(
                        '["bundles/runtime.31225bc6356684ad8e3d.js","bundles/__LANG__.7033.5039167b636e56f6d4e3.js","bundles/1996.25e6f30e7a095ec239f4.css","bundles/207.dd2de59fb0b299b4eed5.js","bundles/library.1fe0b22985f5c8c6e4ad.js"]'
                    ),
                    ...
                    s = `\n${(function (e, t, i) {
                        ...
                        for (const n of e)
                            n.endsWith(".js")
                                ...
                                : n.endsWith(".css") &&
                                r.push(
                                    `<link type="text/css" href="${t ? n.replace(/\.css$/i, ".rtl.css") : n
                                    }" rel="stylesheet"/>`
                                );
                        return [...o, ...r].join("\n");
                    })(o, "rtl" === n.dir, r)}\n`;
                return `<!DOCTYPE html><html ${(l = { bundles: s, localeLanguage: r, htmlAttrs: a, libraryPath: i })
                        .htmlAttrs
                    }><head><base href="${l.libraryPath
                    }"><meta charset="utf-8"><script>window===window.parent&&(location.href="about:blank")<\/script> ${l.bundles
            ...
            const a =
                ...
                (this._options.time_scale
                    ...
                    : "");
            return [
                `<iframe\n\t\tversion="CL v29.6.0 (internal id 7388a2a6e02df803a33011b40077c533f89a55f0 @ 2025-08-13T13:50:29.067Z)" id="${this._id
